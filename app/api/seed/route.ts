      ...
      metadata: {
        ...
        quizData: {
          ...
          crossword: {
            ...
            clues: {
              across: [
                { number: 1, clue: "مجموعات الأندية في الدوري (3 حروف)", row: 0, col: 0, answer: "فرق" },
                { number: 2, clue: "ضرب الكرة بالقدم (3 حروف)", row: 1, col: 0, answer: "ركل" },
                { number: 3, clue: "لاعب وسط الملعب (3 حروف)", row: 2, col: 0, answer: "قلب" }
              ],
              down: [
                { number: 1, clue: "الاختلاف في النقاط بين الأندية (3 حروف)", row: 0, col: 0, answer: "فرق" },
                { number: 2, clue: "تسديد الكرة بقوة (3 حروف)", row: 0, col: 1, answer: "ركل" },
                { number: 3, clue: "عضو حيوي في فريق الكرة (مجازاً) (3 حروف)", row: 0, col: 2, answer: "قلب" }
              ]
            }
          }
        }
